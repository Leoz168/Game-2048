...
class Tile:
    COLORS = [
        ...
        (237, 197, 63), #1024
        (237, 194, 46), #2048
        (237, 207, 114), # following are same as 128, 256, ...
        (237, 204, 97),
        (237, 200, 80),
        (237, 197, 63),
        (237, 194, 46)
...
def move_tiles(window, tiles, clock, direction, score):
        ...
        for i, tile in enumerate(sorted_tiles):
            ...
            if not next_tile:
                ...
                if merge_check(tile, next_tile):
                    ...
                    next_tile.value *= 2
                    score += next_tile.value  # Update score when tiles merge
                    sorted_tiles.pop(i)
    ...
    return end_move(tiles, moved), score  # Changed this line to pass and return the score

def end_move(tiles, moved):  # Changed this line to accept moved variable
    if len(tiles) == 16:
        return "lost"
    
    if moved:  # Added this condition
